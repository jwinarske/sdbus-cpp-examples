...
#ifndef __sdbuscpp__src_proxy_UDisks2Filesystem_proxy_h__proxy__H__
#define __sdbuscpp__src_proxy_UDisks2Filesystem_proxy_h__proxy__H__
...
public:
    ...
    {
        std::string result;
        m_proxy.callMethod("Mount").onInterface(INTERFACE_NAME).withArguments(options).storeResultsTo(result);
        return result;
    }

    void Unmount(const std::map<std::string, sdbus::Variant>& options)
    {
        m_proxy.callMethod("Unmount").onInterface(INTERFACE_NAME).withArguments(options);
    }
    ...
    {
        bool result;
        m_proxy.callMethod("Check").onInterface(INTERFACE_NAME).withArguments(options).storeResultsTo(result);
        return result;
    }
    ...
    {
        bool result;
        m_proxy.callMethod("Repair").onInterface(INTERFACE_NAME).withArguments(options).storeResultsTo(result);
        return result;
    }

    void TakeOwnership(const std::map<std::string, sdbus::Variant>& options)
    {
        m_proxy.callMethod("TakeOwnership").onInterface(INTERFACE_NAME).withArguments(options);
    }

public:
    std::vector<std::vector<uint8_t>> MountPoints()
    {
        return m_proxy.getProperty("MountPoints").onInterface(INTERFACE_NAME).get<std::vector<std::vector<uint8_t>>>();
    }
