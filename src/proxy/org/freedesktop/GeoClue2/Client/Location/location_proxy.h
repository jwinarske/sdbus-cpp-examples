...
{
public:
    static constexpr const char* INTERFACE_NAME = "org.freedesktop.GeoClue2.Location";

protected:
    Location_proxy(sdbus::IProxy& proxy)
        : m_proxy(proxy)
    {
    }
...
public:
    double Latitude()
    {
        return m_proxy.getProperty("Latitude").onInterface(INTERFACE_NAME).get<double>();
    }

    double Longitude()
    {
        return m_proxy.getProperty("Longitude").onInterface(INTERFACE_NAME).get<double>();
    }

    double Accuracy()
    {
        return m_proxy.getProperty("Accuracy").onInterface(INTERFACE_NAME).get<double>();
    }

    double Altitude()
    {
        return m_proxy.getProperty("Altitude").onInterface(INTERFACE_NAME).get<double>();
    }
    ...
    double Heading()
    {
        return m_proxy.getProperty("Heading").onInterface(INTERFACE_NAME).get<double>();
    }
    ...
    {
        return m_proxy.getProperty("Timestamp").onInterface(INTERFACE_NAME).get<sdbus::Struct<uint64_t, uint64_t>>();
    }
