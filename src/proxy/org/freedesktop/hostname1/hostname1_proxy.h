...
#ifndef __sdbuscpp__src_proxy_org_freedesktop_hostname1_hostname1_proxy_h__proxy__H__
#define __sdbuscpp__src_proxy_org_freedesktop_hostname1_hostname1_proxy_h__proxy__H__
