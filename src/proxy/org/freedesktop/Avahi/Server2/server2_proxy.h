...
#ifndef __sdbuscpp__src_proxy_org_freedesktop_Avahi_Server2_server2_proxy_h__proxy__H__
#define __sdbuscpp__src_proxy_org_freedesktop_Avahi_Server2_server2_proxy_h__proxy__H__
