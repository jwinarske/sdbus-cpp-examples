...
#ifndef __sdbuscpp__src_proxy_org_freedesktop_Avahi_Server_server_proxy_h__proxy__H__
#define __sdbuscpp__src_proxy_org_freedesktop_Avahi_Server_server_proxy_h__proxy__H__
...
class Server_proxy {
 ...
 protected:
  Server_proxy(sdbus::IProxy& proxy) : m_proxy(proxy) {}
 ...
 public:
  ...
  sdbus::ObjectPath DomainBrowserNew(const int32_t& interface,
                                     const int32_t& protocol,
                                     const std::string& domain,
                                     const int32_t& btype,
                                     const uint32_t& flags) {
    sdbus::ObjectPath result;
    m_proxy.callMethod("DomainBrowserNew")
        .onInterface(INTERFACE_NAME)
  ...
  sdbus::ObjectPath ServiceTypeBrowserNew(const int32_t& interface,
                                          const int32_t& protocol,
                                          const std::string& domain,
                                          const uint32_t& flags) {
    sdbus::ObjectPath result;
    m_proxy.callMethod("ServiceTypeBrowserNew")
        .onInterface(INTERFACE_NAME)
  ...
  sdbus::ObjectPath ServiceBrowserNew(const int32_t& interface,
                                      const int32_t& protocol,
                                      const std::string& type,
                                      const std::string& domain,
                                      const uint32_t& flags) {
    sdbus::ObjectPath result;
    m_proxy.callMethod("ServiceBrowserNew")
        .onInterface(INTERFACE_NAME)
  ...
  sdbus::ObjectPath ServiceResolverNew(const int32_t& interface,
                                       const int32_t& protocol,
                                       const std::string& name,
                                       const std::string& type,
                                       const std::string& domain,
                                       ...
                                       const uint32_t& flags) {
    sdbus::ObjectPath result;
    m_proxy.callMethod("ServiceResolverNew")
        .onInterface(INTERFACE_NAME)
        .withArguments(interface, protocol, name, type, domain, aprotocol,
                       flags)
        .storeResultsTo(result);
  ...
  sdbus::ObjectPath HostNameResolverNew(const int32_t& interface,
                                        const int32_t& protocol,
                                        const std::string& name,
                                        const int32_t& aprotocol,
                                        const uint32_t& flags) {
    sdbus::ObjectPath result;
    m_proxy.callMethod("HostNameResolverNew")
        .onInterface(INTERFACE_NAME)
        .withArguments(interface, protocol, name, aprotocol, flags)
        .storeResultsTo(result);
    return result;
  ...
  sdbus::ObjectPath AddressResolverNew(const int32_t& interface,
                                       const int32_t& protocol,
                                       const std::string& address,
                                       const uint32_t& flags) {
    sdbus::ObjectPath result;
    m_proxy.callMethod("AddressResolverNew")
        .onInterface(INTERFACE_NAME)
        .withArguments(interface, protocol, address, flags)
        .storeResultsTo(result);
    return result;
  ...
  sdbus::ObjectPath RecordBrowserNew(const int32_t& interface,
                                     const int32_t& protocol,
                                     const std::string& name,
                                     ...
                                     const uint32_t& flags) {
    sdbus::ObjectPath result;
    m_proxy.callMethod("RecordBrowserNew")
        .onInterface(INTERFACE_NAME)
