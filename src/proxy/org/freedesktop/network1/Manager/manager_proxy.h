...
{
public:
    static constexpr const char* INTERFACE_NAME = "org.freedesktop.network1.Manager";
...
public:
    std::vector<sdbus::Struct<int32_t, std::string, sdbus::ObjectPath>> ListLinks()
    {
        std::vector<sdbus::Struct<int32_t, std::string, sdbus::ObjectPath>> result;
        m_proxy.callMethod("ListLinks").onInterface(INTERFACE_NAME).storeResultsTo(result);
        return result;
    }

    std::tuple<int32_t, sdbus::ObjectPath> GetLinkByName(const std::string& name)
    {
        std::tuple<int32_t, sdbus::ObjectPath> result;
        m_proxy.callMethod("GetLinkByName").onInterface(INTERFACE_NAME).withArguments(name).storeResultsTo(result);
        return result;
    }

    std::tuple<std::string, sdbus::ObjectPath> GetLinkByIndex(const int32_t& ifindex)
    {
        std::tuple<std::string, sdbus::ObjectPath> result;
        m_proxy.callMethod("GetLinkByIndex").onInterface(INTERFACE_NAME).withArguments(ifindex).storeResultsTo(result);
        return result;
    }

    void SetLinkNTP(const int32_t& ifindex, const std::vector<std::string>& servers)
    {
        m_proxy.callMethod("SetLinkNTP").onInterface(INTERFACE_NAME).withArguments(ifindex, servers);
    }
    ...
    {
        m_proxy.callMethod("RevertLinkNTP").onInterface(INTERFACE_NAME).withArguments(ifindex);
    }

    void RevertLinkDNS(const int32_t& ifindex)
    {
        m_proxy.callMethod("RevertLinkDNS").onInterface(INTERFACE_NAME).withArguments(ifindex);
    }

    void RenewLink(const int32_t& ifindex)
    {
        m_proxy.callMethod("RenewLink").onInterface(INTERFACE_NAME).withArguments(ifindex);
    }

    void ForceRenewLink(const int32_t& ifindex)
    {
        m_proxy.callMethod("ForceRenewLink").onInterface(INTERFACE_NAME).withArguments(ifindex);
    }

    void ReconfigureLink(const int32_t& ifindex)
    {
        m_proxy.callMethod("ReconfigureLink").onInterface(INTERFACE_NAME).withArguments(ifindex);
    }
    ...
    {
        std::string result;
        m_proxy.callMethod("DescribeLink").onInterface(INTERFACE_NAME).withArguments(ifindex).storeResultsTo(result);
        return result;
    }
...
public:
    ...
    {
        return m_proxy.getProperty("NamespaceId").onInterface(INTERFACE_NAME).get<uint64_t>();
    }
