...
#ifndef __sdbuscpp__src_proxy_org_freedesktop_login1_User_user_proxy_h__proxy__H__
#define __sdbuscpp__src_proxy_org_freedesktop_login1_User_user_proxy_h__proxy__H__
