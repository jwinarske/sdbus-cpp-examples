...
class Link_proxy {
 ...
 public:
  ...
  void Revert() { m_proxy.callMethod("Revert").onInterface(INTERFACE_NAME); }

 public:
  uint64_t ScopesMask() {
    return m_proxy.getProperty("ScopesMask")
        .onInterface(INTERFACE_NAME)
        .get<uint64_t>();
  }
  ...
  std::vector<sdbus::Struct<int32_t, std::vector<uint8_t>>> DNS() {
    return m_proxy.getProperty("DNS")
        .onInterface(INTERFACE_NAME)
        .get<std::vector<sdbus::Struct<int32_t, std::vector<uint8_t>>>>();
  }
  ...
  DNSEx() {
    return m_proxy.getProperty("DNSEx")
        .onInterface(INTERFACE_NAME)
        .get<std::vector<sdbus::Struct<int32_t, std::vector<uint8_t>, uint16_t,
                                       std::string>>>();
  }
  ...
  CurrentDNSServerEx() {
    return m_proxy.getProperty("CurrentDNSServerEx")
        .onInterface(INTERFACE_NAME)
        .get<sdbus::Struct<int32_t, std::vector<uint8_t>, uint16_t,
                           std::string>>();
  }
  ...
  bool DefaultRoute() {
    return m_proxy.getProperty("DefaultRoute")
        .onInterface(INTERFACE_NAME)
        .get<bool>();
  }
