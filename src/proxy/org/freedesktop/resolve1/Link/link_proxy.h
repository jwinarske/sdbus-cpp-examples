...
#ifndef __sdbuscpp__src_proxy_org_freedesktop_resolve1_Link_link_proxy_h__proxy__H__
#define __sdbuscpp__src_proxy_org_freedesktop_resolve1_Link_link_proxy_h__proxy__H__
