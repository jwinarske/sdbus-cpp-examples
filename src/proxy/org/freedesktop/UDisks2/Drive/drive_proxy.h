...
#ifndef __sdbuscpp__src_proxy_org_freedesktop_UDisks2_Drive_drive_proxy_h__proxy__H__
#define __sdbuscpp__src_proxy_org_freedesktop_UDisks2_Drive_drive_proxy_h__proxy__H__
