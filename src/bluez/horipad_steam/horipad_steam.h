...
#ifndef SRC_BLUEZ_HORIPAD_STEAM_HORIPAD_STEAM_H
#define SRC_BLUEZ_HORIPAD_STEAM_HORIPAD_STEAM_H
...
class HoripadSteam final
 ...
 private:
  const std::string VENDOR_ID = "0F0D";
  const std::string PRODUCT_ID = "0196";
...
#endif  // SRC_BLUEZ_HORIPAD_STEAM_HORIPAD_STEAM_H
