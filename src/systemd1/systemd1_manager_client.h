...
#include "../proxy/org/freedesktop/systemd1/Service/service_proxy.h"
...
class Systemd1ManagerClient final
 ...
 public:
  static constexpr const char* SERVICE_NAME = "org.freedesktop.systemd1";
  static constexpr const char* OBJECT_PATH = "/org/freedesktop/systemd1";

  explicit Systemd1ManagerClient(sdbus::IConnection& connection);
  ~Systemd1ManagerClient();

  // Required override from Properties_proxy to avoid abstract type
