...
#include "../proxy/org/freedesktop/network1/Network/network_proxy.h"
...
class Network1ManagerClient final
 ...
 public:
  static constexpr const char* SERVICE_NAME = "org.freedesktop.network1";
  static constexpr const char* OBJECT_PATH = "/org/freedesktop/network1";

  explicit Network1ManagerClient(sdbus::IConnection& connection);
  ~Network1ManagerClient();

  struct LinkInfo { int32_t ifindex{}; std::string name; sdbus::ObjectPath path; };
