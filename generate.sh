...
${XML2CPP} --verbose --proxy=${PROXY}/org/bluez/Input1/input_proxy.h interfaces/org/bluez/Input1/Input1.xml
...
mkdir -p ${PROXY}/org/freedesktop/PackageKit/{Offline,Transaction} |true
